...
exports.handler = async (event) => {
    ...
    try {
        const { cart, customerName, customerPhone, deliveryType, address, deliveryTime, shippingFee, agentRef, paymentMethod, orderNumber: clientOrderNumber, userId } = JSON.parse(event.body);
